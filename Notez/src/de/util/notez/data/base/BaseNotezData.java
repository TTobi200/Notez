 ...
 * This class also provides the ability to transform any notezdata into a serializable pendant via
 * {@link #asSerializableData(NotezData)}
 *
 * @author ddd
 */
public class BaseNotezData implements NotezData
{
	 ...
	 * @author ddd
	 */
	private static final class SerializableNotezData extends BaseNotezData implements Serializable
	{
				...
				Serializable
		{
			 ...
			 * @author ddd
			 */
			private static final class SerializableNotezTextData extends BaseNotezTextData
