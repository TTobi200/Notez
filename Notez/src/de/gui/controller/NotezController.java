...
public class NotezController extends NotezControllerBase<NotezControllerListeners>
{
	...
	{
		NotezProperties.set(NotezProperties.PROP_NOTEZ_WORK_FOLDER, txtPropNotezWorkFold.getText());
...
//		c.addFileLink(fileLink, note);
		...
		if (NotezFileUtil.fileCanBeLoad(note))
		{
			...
			c.doOnShowing(() -> c.moveStageAnimatedTo(stageData.getStageX(),
				stageData.getStageY()));
