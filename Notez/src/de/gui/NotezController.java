...
public class NotezController
{
    ...
    public static final String ICON_PICK_NOTE = "include/icons/pn-add-source-copy_2.gif";
    ...
    private void initSettings(Map<String, Setting<Object>> all)
    {
        ...
        colUsername.setCellValueFactory(
            new PropertyValueFactory<NotezRemoteUser, String>("username"));
        colFolder.setCellValueFactory(
            new PropertyValueFactory<NotezRemoteUser, String>("remoteFolder"));
    }
        ...
        stage.showingProperty().addListener(new ChangeListener<Boolean>()
        {
                            ...
                            Boolean oldValue, Boolean newValue)
            {
                if(newValue.booleanValue())
                {
                    ...
                    new Timeline(new KeyFrame(DUR,
                        new KeyValue(x, pos.getX()),
    ...
    private void shareNote() throws IOException, InterruptedException
    {
            ...
            "Share this Notez with HERTEL-1"))
        {
            ...
            case OK:
            case YES:
                NotezRemoteSync.getUser("HERTEL-1").
                    shareNotez(this, note);
                break;
        }
    }
