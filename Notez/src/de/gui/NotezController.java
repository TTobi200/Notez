...
public class NotezController
{
	...
	protected ObjectProperty<NotezController>						noteParent;
	/** the child of this node */
	protected ObjectProperty<NotezController>						noteChild;
	...
	protected void pinToNode(NotezController noteToPin)
	{
		if(noteToPin == this)
		{
			return;
